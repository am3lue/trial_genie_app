...
# !!! Main.UserApp is configured as an alias for Main.Try and you might encounter it in some tests
using Main.Try, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Try tests" begin
  @includetests ARGS
end
